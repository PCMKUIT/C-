...
class XuLyDoiTuong{
	private: NgheNghiep *DuLieu;
	public:
	XuLyDoiTuong(){}
	~XuLyDoiTuong(){if(DuLieu!=NULL) {delete [] DuLieu; DuLieu = NULL;}}
	
	void Nhap(){
		int LoaiDoiTuong;
		cout<<"Nhap thong tin cua doi tuong: ";
		...
		cout<<"\nNhap mot so nguyen tu 1 den 5: ";
		cin>>LoaiDoiTuong;
		while(LoaiDoiTuong!=1&&LoaiDoiTuong!=2&&LoaiDoiTuong!=3&&LoaiDoiTuong!=4&&LoaiDoiTuong!=5)
			{cout<<"Cau lenh khong hop le, vui long nhap lai mot so nguyen tu 1 den 5: ";
			 cin>>LoaiDoiTuong;}
		switch (LoaiDoiTuong){
			case 1: DuLieu = new SinhVien; break;
			case 2: DuLieu = new HocSinh; break;
			case 3: DuLieu = new CongNhan; break;
			case 4: DuLieu = new NgheSi; break;
			case 5: DuLieu = new CaSi; break;}
		DuLieu->Nhap();}
			
	void Xuat() const {	cout<<"\nThong tin cua doi tuong:\n"; DuLieu->Xuat();}
};

int main (){
	XuLyDoiTuong DoiTuong;
	DoiTuong.Nhap();
	DoiTuong.Xuat();
	return 0;}