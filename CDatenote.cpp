...
class CDate{
    	...
    	/*while(true){
    		switch(c.Thang){
    			case 1:case 3:case 5:case 7:case 8:case 10:case 12:{
    				   if(c.Ngay>31){c.Ngay-=31;c.Thang++;}
    				   else return c;
    				   if(c.Thang>12){c.Thang-=12;c.Nam++;}
					   break;}
    			case 2:{if(Leap(c.Nam)){
    					if(c.Ngay>29){c.Ngay-=29;c.Thang++:}
    					else return c;}
    					else{
    					if(c.Ngay>28){c.Ngay-=28;c.Thang++;}
    					else return c;}
    					break;}
    			case 4:case 6:case 9:case 11:{
    				   if(c.Ngay>30){c.Ngay-=30;c.Thang++;}
    				   else return c;
					   break;}}}}*/
	CDate Tru(CDate a,int b){
    	...
    	return c;}
		/*while(true){
			if(c.Ngay>0) return c;
			else c.Thang--;
			switch(c.Thang){
				case 0:{c.Ngay+=31;c.Thang=12;c.Nam--;break;}
				case 1:case 3:case 5:case 7:case 8:case 10:case 12:{c.Ngay+=31;break;}
				case 2:{if(Leap(c.Nam)) c.Ngay+=29; else c.Ngay+=28; break;}
				case 4:case 6:case 9:case 11:{c.Ngay+=30;break;}}}}*/
